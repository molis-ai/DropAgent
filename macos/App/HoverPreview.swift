...
struct HoverPreview: View {
    ...
    private var card: some View {
        VStack(alignment: .leading, spacing: 8) {
            ...
            if scrolling {
                ScrollView([.vertical, .horizontal], showsIndicators: true) {
                    payload
                        .frame(minWidth: HoverPlacement.innerWidth, alignment: .topLeading)
                }
        ...
        .frame(height: scrolling ? cardHeight : nil, alignment: .topLeading)
        ...
        .fixedSize(
            horizontal: lockCardWidth == false || scrolling == false,
